import{m as C,r as _,j as r}from"./index-4bdd885e.js";import{A as S}from"./api-aee67127.js";import{m as j,d as D,b as y,g as N,i as R,e as P,u as B,H as E}from"./PublicPrescriptionView-440f580d.js";import"./store-adc85da8.js";const O="/assets/logo-7f0cd0bc.png",G=async()=>(await j.get("/auth/hospital-profile")).data,ie=async e=>(await j.put("/auth/hospital-profile",e)).data,g="/staff",ce=async()=>y(g),F=async e=>D(g,e),M=async e=>y(`${g}/employee/${e}`),me=async e=>R(g,e),de=async(e,t)=>N(g,e,t),pe=async(e,t)=>(await j.put(`${g}/${e}/reset-password`,{newPassword:t})).data,ue=async e=>P(g,e),f="/stamps",ge=async()=>y(f),L=async e=>y(`${f}/department/${e}`),be=async e=>R(f,e),fe=async(e,t)=>N(f,e,t),_e=async e=>P(f,e),he=async e=>N(f,`${e}/toggle`,{}),xe=async(e,t)=>{const a=new FormData;a.append("stamp",e),a.append("name",t.name),a.append("description",t.description||""),a.append("department",t.department),a.append("category",t.category),a.append("createdBy",t.createdBy);const n=localStorage.getItem("token"),i={};n&&(i["x-auth-token"]=n);const c=await fetch(`${S.BASE_URL}/api/upload/stamp`,{method:"POST",headers:i,body:a});if(!c.ok){const l=await c.json();throw new Error(l.error||"Failed to upload stamp")}return c.json()},v=async e=>{try{let t;try{t=await M(e)}catch{t=await F(e)}return(t==null?void 0:t.signatureUrl)||null}catch(t){return console.error("Error fetching doctor signature:",t),null}},V=async e=>{try{const t=await L(e);return(t==null?void 0:t.filter(a=>a.isActive))||[]}catch(t){return console.error("Error fetching department stamps:",t),[]}},W=async()=>{try{const e=await L("General");return(e==null?void 0:e.filter(t=>t.isActive&&t.category==="hospital"))||[]}catch(e){return console.error("Error fetching hospital stamps:",e),[]}};function q(e,t="general"){const a=(e==null?void 0:e.settings)||{},n=[];return t==="pharmacy"&&a.drugLicenseNumber&&n.push({label:"DL No.",value:a.drugLicenseNumber}),n}function ye(e){var t;return((t=e==null?void 0:e.settings)==null?void 0:t.receiptFooterNote)||""}function $(e=[]){return e.filter(a=>a.isActive!==!1&&a.imageUrl)[0]||null}function K(e){return[e==null?void 0:e.address,[e==null?void 0:e.city,e==null?void 0:e.state].filter(Boolean).join(", "),e==null?void 0:e.zipCode].filter(Boolean).join(", ")}const Y=`
  @page {
    size: A4 portrait;
...
`;function T(e,{documentTitle:t,departmentName:a}){const n=q(e,"lab"),i=K(e),c=[e!=null&&e.phone?`Phone: ${e.phone}`:null,(e==null?void 0:e.email)||null,a||null,...n.map(({label:l,value:s})=>`${l}: ${s}`)].filter(Boolean);return`
  ...
  `}function J(e,t,a=""){return`
    <div class="printable-document-footer__cell printable-document-footer__cell--signature">
      <div class="printable-document-footer__image-wrap printable-document-footer__image-wrap--signature">
        ${e?`<img src="${e}" alt="${t}" class="printable-document-footer__image printable-document-footer__image--signature" />`:'<div class="printable-document-footer__placeholder">Signature</div>'}
      </div>
      <p class="printable-document-footer__label">${t}</p>
      ${a?`<p class="printable-document-footer__sub">${a}</p>`:""}
    </div>
  `}function Q(e,t){return`
    <div class="printable-document-footer__cell printable-document-footer__cell--stamp">
      <div class="printable-document-footer__image-wrap printable-document-footer__image-wrap--stamp">
        ${e!=null&&e.imageUrl?`<img src="${e.imageUrl}" alt="${e.name||t}" class="printable-document-footer__image printable-document-footer__image--stamp" />`:`<div class="printable-document-footer__placeholder printable-document-footer__placeholder--stamp">${t}</div>`}
      </div>
      <p class="printable-document-footer__label">${t}</p>
      ${e!=null&&e.name?`<p class="printable-document-footer__sub">${e.name}</p>`:""}
    </div>
  `}function A({technicianSignature:e,technicianName:t,reviewerSignature:a,reviewerName:n,departmentStamp:i,hospitalStamp:c,primaryLabel:l="Lab Incharge",secondaryLabel:s="Verified By"}){return`
    <footer class="printable-document-footer">
      <div class="printable-document-footer__grid">
        ${J(e||a||null,e?l:a?s:l,t||n||"")}
  ...
  `}function U(e,t){const a=(n,i)=>`
    <div>
      <p class="cr-meta-block__heading">${n}</p>
      ${i.map(({label:c,value:l})=>`<p class="cr-meta-block__row"><strong>${c}:</strong> ${l??"—"}</p>`).join("")}
    </div>
  `;return`
    <div class="cr-meta-grid">
      ${a(e.heading||"Patient",e.rows)}
      ${a(t.heading||"Report",t.rows)}
    </div>
  `}function H(e){return typeof(e==null?void 0:e.normal_range)=="string"?e.normal_range:e!=null&&e.normal_range?`${e.normal_range.adult_male||"N/A"} (M) / ${e.normal_range.adult_female||"N/A"} (F)`:"N/A"}function X(e){return!(e==null||typeof e=="string"&&!e.trim())}function Z(e,t={}){var c;const a=e._id||e.code;return`
    <table class="cr-table">
      ...
      <tbody>${(((c=e.parameters)==null?void 0:c.map(l=>{var u;const s=(u=t[a])==null?void 0:u[l.id||l.name],o=(s==null?void 0:s.value)??l.result;if(!X(o))return null;const d=(s==null?void 0:s.isAbnormal)??l.isAbnormal?"cr-result-abnormal":"cr-result-normal";return`
        <tr>
  ...
  `}async function ve(e,t=[]){const[a,n,i]=await Promise.all([G(),V("Laboratory"),W()]);let c=null,l="",s=null,o="";if((e==null?void 0:e.type)==="LabTechnician"&&(e!=null&&e.id))c=e.signatureUrl||await v(e.id),l=e.name||"";else{const d=t.find(u=>u.type==="LabTechnician"&&u.active!==!1);d!=null&&d.id&&(c=d.signatureUrl||await v(d.id),l=d.name||"")}const p=t.find(d=>d.type==="Doctor"&&d.active!==!1)||null;return p!=null&&p.id&&(s=p.signatureUrl||await v(p.id),o=p.name||""),{hospital:a,technicianSignature:c,technicianName:l,reviewerSignature:s,reviewerName:o,departmentStamp:$(n),hospitalStamp:$(i)}}function I({title:e,bodyHtml:t}){const a=window.open("","_blank");a&&(a.document.write(`<!DOCTYPE html>
    <html>
      <head>
        <meta charset="utf-8" />
        <title>${e}</title>
  ...
  `),a.document.close())}function je({hospital:e,assets:t,receipt:a,test:n,reportContent:i}){const c=new Date,l=`
    ${T(e,{documentTitle:"Radiology Report",departmentName:"Department of Radiology"})}
    ${U({heading:"Patient",rows:[{label:"Name",value:a==null?void 0:a.patientName},{label:"Phone",value:a==null?void 0:a.patientPhone}]},{heading:"Study",rows:[{label:"Test",value:n==null?void 0:n.name},{label:"Date",value:c.toLocaleDateString("en-IN")},{label:"Time",value:c.toLocaleTimeString("en-IN",{hour:"2-digit",minute:"2-digit"})}]})}
