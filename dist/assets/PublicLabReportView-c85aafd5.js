...
`;function M(e,{documentTitle:r,departmentName:o}){const t=w(e);if(t.printOnLetterhead||t.showHeader===!1)return r?`
      ...
      `:"";const m=te(e,"lab"),i=t.showAddress!==!1?le(e):null,c=t.showLogo!==!1&&(e==null?void 0:e.logoUrl),l=t.showHospitalName!==!1,s=t.showContactInfo!==!1,a=[s&&(e!=null&&e.phone)?`Phone: ${e.phone}`:null,s&&(e!=null&&e.email)?e.email:null,o||null,...m.map(({label:d,value:u})=>d.includes("GST")&&t.showGstNumber===!1||d.includes("DL")&&t.showDrugLicense===!1||d.includes("LL")&&t.showLabLicense===!1?null:`${d}: ${u}`)].filter(Boolean);return`
      ...
      <div class="printable-document-header__grid">
        ...
        <div class="printable-document-header__content">
          <div class="printable-document-header__title-row">
            ${l?`<h1 class="printable-document-header__name">${(e==null?void 0:e.name)||"Hospital"}</h1>`:"<div></div>"}
  ...
  `}function H({hospital:e,technicianSignature:r,technicianName:o,reviewerSignature:t,reviewerName:m,departmentStamp:i,hospitalStamp:c,primaryLabel:l="Lab Incharge",secondaryLabel:s="Verified By"}){const a=w(e),d=a.showDoctorSignature!==!1||a.showAuthorizedSignature!==!1,u=a.showStamps!==!1,h=!!a.printOnLetterhead;if(h&&!d&&!u)return"";const y=r||t||null,N=o||m||"",v=r?l:t?s:l,j=!h&&a.showTermsAndConditions!==!1&&!!a.termsAndConditions,p=!h&&(a.showFooterNote!==!1&&a.footerNote||""),g=!h&&a.showPrintTimestamp!==!1,b=!h&&a.showComputerGeneratedDisclaimer!==!1,f=!h&&a.showPoweredBy!==!1,O=new Date().toLocaleString("en-IN",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`
  ...
  `}function I(e){return typeof(e==null?void 0:e.normal_range)=="string"?e.normal_range:e!=null&&e.normal_range?`${e.normal_range.adult_male||"N/A"} (M) / ${e.normal_range.adult_female||"N/A"} (F)`:"N/A"}function ce(e){return!(e==null||typeof e=="string"&&!e.trim())}function de(e,r={}){var i;const o=e._id||e.code;return`
    <table class="cr-table">
      ...
      <tbody>
        ${(((i=e.parameters)==null?void 0:i.map(c=>{var u;const l=(u=r[o])==null?void 0:u[c.id||c.name],s=(l==null?void 0:l.value)??c.result;if(!ce(s))return null;const d=(l==null?void 0:l.isAbnormal)??c.isAbnormal?"cr-result-abnormal":"cr-result-normal";return`
        <tr>
  ...
  `),i.document.close()}function Be({hospital:e,assets:r,receipt:o,test:t,reportContent:m}){const i=new Date,c=M(e,{documentTitle:"Radiology Report",departmentName:"Department of Radiology"}),l=`
  ...
  `;G({title:`Radiology Report - ${(t==null?void 0:t.name)||"Report"}`,headerHtml:c,contentHtml:l,hospital:e})}function Ce({hospital:e,assets:r,receipt:o,test:t,resultsMap:m}){const i=new Date,c=M(e,{documentTitle:"Laboratory Report",departmentName:"Department of Laboratory Medicine"}),l=`
